...
labelInfo g_labelArr[LABELS_MAX]; /* Array of labelInfo structures to store labels encountered during assembly. */
lineInfo *g_entryLines[LABELS_MAX]; /* Array of pointers to lineInfo structures for entry lines. */
int g_dataArr[RAM_LIMIT]; /* Array to store data values encountered during assembly. */
